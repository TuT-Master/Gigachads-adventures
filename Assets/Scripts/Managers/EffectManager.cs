...
public class EffectManager : MonoBehaviour
{
    ...
    public void SpawnStain(Transform t, StainType stainType)
    {
        ...
        GameObject newStain = Instantiate(stainPrefab, new Vector3((float)(t.position.x + (rand.Next(100) / 100)), 0.001f, (float)(t.position.z + (rand.Next(100) / 100))), Quaternion.Euler(90, 0, 0), currentRoom);
